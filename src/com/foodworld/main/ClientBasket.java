...
public class ClientBasket {
	...
	public static void main(String[] args) {  
	    ...
	    System.out.println(target.path("Basket").path("Add").request().accept(MediaType.TEXT_PLAIN).get(String.class));  
...
//	    System.out.println(target.path("rest").path("hello").request().accept(MediaType.TEXT_HTML).get(String.class));  
	  ...
	  private static URI getBaseURI() {  
	    ...
	    return UriBuilder.fromUri("http://localhost:8080/FoodWorldAPI").build();  
	  }  
